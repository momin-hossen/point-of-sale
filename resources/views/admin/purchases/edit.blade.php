                ...
                <form action="{{ route('purchases.update', $purchase->id) }}" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <select name="discount_type" class="form-select">
                        ...
                        <option @selected($purchase_info->discount_type == 'percentage') value="percentage">Percentage</option>
                        <option @selected($purchase_info->discount_type == 'fixed') value="fixed">Fixed</option>
                    </select>
                  </div>
                  <div class="mb-3">
